...
`tools/corpus.json` is the corpus, seventeen repositories pinned to the commit
...
Terraform module written by people who know the rules, a Django codebase, a C# one, Spring Boot, and
