...
One hundred and forty-two rules across sixteen families. [docs/RULES.md](docs/RULES.md) is the
...
| [Application code](docs/RULES.md#application-code) | AP001–AP005 | Verification off, debug on, predictable tokens, unsafe loads |
