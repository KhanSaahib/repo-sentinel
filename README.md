...
One hundred and twenty-five rules across fifteen families. [docs/RULES.md](docs/RULES.md) is the
...
| [GitHub Actions](docs/RULES.md#github-actions-workflows) | WF001–WF011 | Script injection, token scope, privileged triggers |
